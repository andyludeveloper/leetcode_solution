...
class Leetcode11Test : FunSpec({
    ...
    test("2points [1,8,6,2,5,4,8,3,7] should return 49") {
        val intArray = intArrayOf(1, 8, 6, 2, 5, 4, 8, 3, 7)
        val sut = Leetcode11()
        sut.maxArea2Points(intArray) shouldBe 49
    }
    test("2points [1,1] should return 1") {
        val intArray = intArrayOf(1, 1)
        val sut = Leetcode11()
        sut.maxArea2Points(intArray) shouldBe 1
    }
    test("2 points [4,3,2,1,4] should return 1") {
        val intArray = intArrayOf(4,3,2,1,4)
        val sut = Leetcode11()
        sut.maxArea2Points(intArray) shouldBe 16
    }
    test("2 points [1,2,1] should return 1") {
        val intArray = intArrayOf(1,2,1)
        val sut = Leetcode11()
        sut.maxArea2Points(intArray) shouldBe 2
    }
